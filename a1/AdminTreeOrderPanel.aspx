<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminTreeOrderPanel.aspx.cs" Inherits="a1.TreeOrderPanel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Trees" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
      ...
      <div class="form-group row">
          <div class="col-lg-5">
            <label for="exampleFormControlInput1">TreeId</label>
            <asp:TextBox ID="tbx_AddTreeId" CssClass="form-control" runat="server"></asp:TextBox>

            <label for="exampleFormControlInput1">CustomerId</label>
            <asp:TextBox ID="tbx_CustomerId" CssClass="form-control" runat="server"></asp:TextBox>
          ...
          <div class="col-lg-5">
            ...
            <label for="exampleFormControlInput1">TreeId</label>
            <asp:TextBox ID="tbx_UpdateTreeId" CssClass="form-control" runat="server"></asp:TextBox>
