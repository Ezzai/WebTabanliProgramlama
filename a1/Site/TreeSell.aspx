<%@ Page Title="" Language="C#" MasterPageFile="~/Site/TreeSeller.Master" AutoEventWireup="true" CodeBehind="TreeSell.aspx.cs" Inherits="a1.Site.TreeSell" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            <asp:GridView ID="Grd_Trees" AutoGenerateColumns="false" AllowPaging="true"  OnPageIndexChanging="Grd_Trees_PageIndexChanging" Width="400%" PageSize="1" BackImageUrl="img/bg-img/1.jpg"  runat="server">
                ...
                <PagerStyle CssClass="btn alazea-btn w-100" />
            </asp:GridView>
        </ContentTemplate>
